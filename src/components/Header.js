...
const Header = ({query}) => {
  ...
  return (
    <header>
    <nav class="bg-white border-neutral-200 py-8 dark:bg-neutral-800  flex flex-row">
    ...
    <img class="h-20   " src={logo} alt="logo" />
        ...
        <div class="flex flex-row  justify-between items-left ml-12 ">
            ...
            <input value={value } onChange={(e) => setValue(e.target.value)} style={{width: "600px"}}  type="text" id="query" class="mt-4  h-12  p-4 pl-10 text-sm text-neutral-900 border border-neutral-300 rounded-lg bg-neutral-50 focus:ring-red-500 focus:border-red-500 dark:bg-neutral-700 dark:border-neutral-600 dark:placeholder-neutral-400 dark:text-white dark:focus:ring-red-500 dark:focus:border-red-500 appearance-none " placeholder="text" required />
        ...
        <svg class="ml-6 h-12 mx-auto mb-3 text-neutral-400 dark:text-neutral-600" viewBox="0 0 24 27" fill="none" xmlns="http://www.w3.org/2000/svg">
